...
public class MainScene {
  ...
  public static void main(String[] args) {
    JFrame frame = new JFrame("MainScene");
  ...
  public static class CoordinateArea extends JComponent implements MouseInputListener {
    ...
    public CoordinateArea(MainScene controller) {
    ...
    // Draws a 20x20 grid using the current color. (Turned off right now)
    ...
    public void mouseMoved(MouseEvent e) {
      //When the mouse is moved, the location is updated
